    ...
    <footer class="main-footer">
        <div class="footer-left">
            Copyright &copy <div class="bullet"></div> Design By <a href="https://nauval.in/"></a>
        </div>
        <div class="footer-right">
            Dibuat dengan <i class="fas fa-heart text-danger"></i> oleh <a href="https://rafipriatna.id" target="_blank" rel="noopener noreferrer"></a>
        </div>
    </footer><?php /**PATH C:\Users\Fahreza\Downloads\project pemweb\resources\views/layouts/footer.blade.php ENDPATH**/ ?>